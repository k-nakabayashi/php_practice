...
if (!(empty($_POST))) {
  ...
  if(empty($err_msg)) {
    ...
    //テキスト入力だし、バリデーションいらんかな？
                              //画像変更ありの場合
    if (empty($err_msg) && ($upload1_flg == true) ) {
      //imageを保存
      $item_img1 = uploadImg($_FILES['item_img1'],'item_img1');

      if(!(empty($item_img2)) && ($upload2_flg == true) ) {
        $item_img2 = uploadImg($_FILES['item_img2'],'item_img2');
      }

      if (!(empty($item_img3)) && ($upload3_flg == true)) {
    ...
    if (empty($err_msg)) {
      ...
      header("Location:/Views/my/confirm-My-Item.php"); //マイページへ
      exit;
          ...
          <div class="item-Detail-wrapper u-clearfix">
            ...
            <div class="put-Item-Img-Wrapper">
              <div class="put-item-Img js-LivePre__img-drop-area">
                  <img class="js-LivePre__img-wrapper js-LivePre__img-src u-border-free-auction" src="<?php echo $item['item_img1']; ?>" 
                  alt="
              ...
              <div class="put-item-Img js-LivePre__img-drop-area ">
                  <img class="js-LivePre__img-wrapper js-LivePre__img-src u-border-free-auction" src="<?php echo $item['item_img2']; ?>" alt="アイテム画像">
                  <!--擬似要素でたすき掛け-->
                  <input class="put-item-File js-LivePre__input-file" type="file" name="item_img2">
              </div>
              
              <div class="put-item-Img js-LivePre__img-drop-area ">
                  <img class="js-LivePre__img-wrapper js-LivePre__img-src u-border-free-auction" src="<?php echo $item['item_img3']; ?>" alt="アイテム画像">
                  <!--擬似要素でたすき掛け-->
              ...
              <div class="put-item-Detail__Profile">
                <div class="item-Profile">
                  <label for="put-item-Title">
                    ...
                    <input class="put-item-Title__input u-border-free-auction" type="text" id="put-item-title" name="item_title" value="<?php echo $item['item_title']; ?>">
                  </label>
                      ...
                      <div class="item-More-Details">
                        ...
                        <label for="put-item-More-Details__textarea">
                          ...
                          <div class="put-item-More-Details__thumb">
                            <textarea class="put-item-More-Details__textarea u-border-free-auction" id="put-item-More-Details__textarea" placeholder="最大文字数は20です" name="item_thumb" ><?php echo $item['item_thumb']; ?></textarea>
                          </div>
                        </label>
                              ...
                              <div class="put-item-Form-Select">
                                <div class="put-item-Form-Select__Select-Down put-item-Form-Select__Arrow-Down">
                                  <select class="put-item-Select-Down" id="" name="item_category">
                                    <option class="u-selected-option" value="<?php echo $item['item_category']; ?>"><?php echo $item['item_category']; ?></option>
                            ...
                            <td>
                              <div class="put-item-Form-Select">
                                <div class="put-item-Form-Select__Select-Down put-item-Form-Select__Arrow-Down">
                                  ...
                                  <option class="u-selected-option" value="<?php echo $item['item_status']; ?>"><?php echo $item['item_status']; ?></option>
                                    <option value="">未選択</option>
                            ...
                            <td>
                              <div class="put-item-Form-Select">
                                <div class="put-item-Form-Select__Select-Down put-item-Form-Select__Arrow-Down">
                                  ...
                                  <option class="u-selected-option" value="<?php echo $item['item_area']; ?>"><?php echo $item['item_area']; ?></option>
                                    <option value="">未選択</option>
              ...
              <div class="put-item-Claim">
                ...
                <label for="put-item-Comment">
                  ...
                  <div class="put-item-More-Details__explain">
                    <textarea class="put-item-More-Details__textarea u-border-free-auction" id="put-item-Comment" placeholder="" name="item_detail"><?php echo $item['item_detail']; ?></textarea>
                  </div>
                </label>
              </div>
              <div class="c-Form-Button">
                  <input class="c-Form-Button_input" type="submit" value="確認画面へ">
              </div>
            </div>
