...
<header class="l-header">
    <div class="l-Header-Wrapper">
        ...
        <ul class="l-Header-Wrapper__list l-Header-List">
            <li><a href="./my/mypage.html" class="u-Arrow-Down">マイページ</a></li>
            <li><a href="./item/item-list.html" class="u-Arrow-Down">商品一覧</a></li>
            <li><a href="/" class="u-Arrow-Down">Top</a></li>
            <li><a href="" class="u-Arrow-Down">ログアウト</a></li>
        </ul>
    </div>
</header>
-->
  ...
  <div class="l-Main-Wrapper">
    ...
    <div class="l-Main-Wrapper__Main-Menu">
        <div class="l-Main-Menu c-Form-Select-Parent"><!--幅と余白は確定-->
          ...
          <ul class="c-obj-List">
            <li class="c-obj-List__obj-Thumbnail"><!--関節クラス扱い-->
                <div class="c-obj-Thumbnail">
                    <a href="/Views//item/Item-Detail.php">
            ...
            <li class="c-obj-List__obj-Thumbnail"><!--関節クラス扱い-->
                <div class="c-obj-Thumbnail">
                    <a href="/item/Item-Detail.html">
                        <div class="c-obj-Thumbnail__img">
                            <img src="/images/bijo.jpg" alt="アイテム画像">
                            <!--擬似要素でたすき掛け-->
                        </div>
                        <div class="c-obj-Thumbnail__paragraph">
                            <h3 class="u-Text-Style5">タイトル</h3>
          ...
          </li>            <li class="c-obj-List__obj-Thumbnail"><!--関節クラス扱い-->
            <div class="c-obj-Thumbnail">
                <a href="/item/Item-Detail.html">
                    <div class="c-obj-Thumbnail__img">
                        <img src="/images/bijo.jpg" alt="アイテム画像">
